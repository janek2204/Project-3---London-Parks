                ...
                <GridColumn>
                  ...
                  <motion.div whileHover={{ scale: 1.5 }} whileTap={{ scale: 0.9 }}>
                    <Modal
                      ...
                      onOpen={() => setOpen(true)}
                      open={open}
                      trigger={<Header as='h3' icon textAlign='center' inverted color='blue'>
                        <Icon name='home' />
                        <Header.Content>{postcode}</Header.Content>
                      </Header>}
                    >
                      <Header as='h1' textAlign='center'>Here is {title}!</Header>
                      <Modal.Content >
                        <Segment raised>
                          <ReactMapGl
                    ...
                    isNaN(getAverage()) ?
                      ...
                      <motion.div whileHover={{ scale: 1.5 }} whileTap={{ scale: 0.9 }}>
                        <Modal
                          ...
                          open={openComment}
                          trigger={<Header as='h3' icon textAlign='center' color='yellow'>
                            <Icon name='star outline' />
